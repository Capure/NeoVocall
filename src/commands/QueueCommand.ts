...
export class QueueCommand extends BaseCommand {
    ...
    public execute(message: IMessage): any {
        ...
        if (Number(message.guild?.queue?.songs.size) > 12) {
            ...
            let index = 0;
            embed.setDescription(indexes[index]).setFooter(`Page ${index + 1} of ${indexes.length}`, "https://raw.githubusercontent.com/Capure/NeoVocall/main/.github/images/info.png");
